...
public class Entity {
    ...
    public BufferedImage up1, up2, down1, down2, left1, left2, right1, right2,
            rightUp1, leftUp1, rightDown1, leftDown1,
            rightUp2, leftUp2, rightDown2, leftDown2,
            leftIdle1, leftIdle2,
    ...
    public boolean dyingAnimation(Graphics2D g2,
                                  BufferedImage image,
                                  int screenX,
                                  int screenY) {
        ...
        if (dyingCounter <= i) alpha = 0f;
        else if (dyingCounter <= i * 2) alpha = 1f;
        else if (dyingCounter <= i * 3) alpha = 0f;
        else if (dyingCounter <= i * 4) alpha = 1f;
        else if (dyingCounter <= i * 5) alpha = 0f;
        else if (dyingCounter <= i * 6) alpha = 1f;
        else if (dyingCounter <= i * 7) alpha = 0f;
        else {
    ...
    public BufferedImage setup(String imagePath, int width, int height) {
        ...
        try {
            ...
            if (image == null) {
                System.err.println("ERROR: null image: " + path);
                return null;
            }
    ...
    public void update() {
        ...
        if (direction == null) {
            direction = idleDirection != null ? idleDirection : "down";
        }
        ...
        if (isMoving) {
            ...
            worldX += Math.round(dx * speed);
            worldY += Math.round(dy * speed);
