...
public class AssetSetter {
	...
	private void place(Entity[] array, int index, Supplier<Entity> factory, int col, int row, String paletteDef) {
...
//		place(gp.monster, 2, () -> new MON_Goblin(gp), 24, 22, null);
		place(gp.monster, 2, () -> new MON_Goblin(gp), 24, 22, "3B8C3B>B03030,276627>7A1F1F");
	}
}
